...
func (r Result) KVList() []any {
	result := []any{
		...
		"Ingester.ChunksDownloadTime", time.Duration(r.Ingester.Store.ChunksDownloadTime).Seconds(),
		"Ingester.ChunkRefsFetchTime", time.Duration(r.Ingester.Store.ChunkRefsFetchTime).Seconds(),
		"Ingester.HeadChunkBytes", r.Ingester.Store.Chunk.HeadChunkBytes,
		"Ingester.HeadChunkLines", r.Ingester.Store.Chunk.HeadChunkLines,
		"Ingester.DecompressedBytes", r.Ingester.Store.Chunk.DecompressedBytes,
		...
		"Ingester.CompressedBytes", r.Ingester.Store.Chunk.CompressedBytes,
		...
		"Querier.ChunksDownloadTime", time.Duration(r.Querier.Store.ChunksDownloadTime).Seconds(),
		"Querier.ChunkRefsFetchTime", time.Duration(r.Querier.Store.ChunkRefsFetchTime).Seconds(),
		"Querier.HeadChunkBytes", r.Querier.Store.Chunk.HeadChunkBytes,
		"Querier.HeadChunkLines", r.Querier.Store.Chunk.HeadChunkLines,
		"Querier.DecompressedBytes", r.Querier.Store.Chunk.DecompressedBytes,
		...
		"Querier.CompressedBytes", r.Querier.Store.Chunk.CompressedBytes,
...
func (s Summary) kvList() []any {
	return []any{
		"Summary.BytesProcessedPerSecond", s.BytesProcessedPerSecond,
		"Summary.LinesProcessedPerSecond", s.LinesProcessedPerSecond,
		"Summary.TotalBytesProcessed", s.TotalBytesProcessed,
		"Summary.TotalLinesProcessed", s.TotalLinesProcessed,
		"Summary.PostFilterLines", s.TotalPostFilterLines,
		"Summary.ExecTime", s.ExecTime,
		"Summary.QueueTime", s.QueueTime,
	}
}
...
func (c Caches) kvList() []any {
	return []any{
		...
		"Cache.Chunk.BytesSent", c.Chunk.BytesSent,
		"Cache.Chunk.BytesReceived", c.Chunk.BytesReceived,
		"Cache.Chunk.DownloadTime", c.Chunk.CacheDownloadTime().Seconds(),
		...
		"Cache.Index.BytesSent", c.Index.BytesSent,
		"Cache.Index.BytesReceived", c.Index.BytesReceived,
		"Cache.Index.DownloadTime", c.Index.CacheDownloadTime().Seconds(),
		...
		"Cache.StatsResult.BytesSent", c.StatsResult.BytesSent,
		"Cache.StatsResult.BytesReceived", c.StatsResult.BytesReceived,
		...
		"Cache.VolumeResult.BytesSent", c.VolumeResult.BytesSent,
		"Cache.VolumeResult.BytesReceived", c.VolumeResult.BytesReceived,
		...
		"Cache.SeriesResult.BytesSent", c.SeriesResult.BytesSent,
		"Cache.SeriesResult.BytesReceived", c.SeriesResult.BytesReceived,
		...
		"Cache.LabelResult.BytesSent", c.LabelResult.BytesSent,
		"Cache.LabelResult.BytesReceived", c.LabelResult.BytesReceived,
		"Cache.Result.DownloadTime", c.Result.CacheDownloadTime().Seconds(),
		...
		"Cache.Result.BytesSent", c.Result.BytesSent,
		"Cache.Result.BytesReceived", c.Result.BytesReceived,
		...
		"Cache.InstantMetricResult.BytesSent", c.InstantMetricResult.BytesSent,
		"Cache.InstantMetricResult.BytesReceived", c.InstantMetricResult.BytesReceived,
		"Cache.InstantMetricResult.DownloadTime", c.InstantMetricResult.CacheDownloadTime().Seconds(),
	}
}
